...
echo "TESTING 10 CONCURRENT USERS" > load_test_report.txt
loadtest http://localhost:9001/ -t 20 -c 10 -k -n 1000 >> load_test_report.txt
echo "================================"
echo "================================"

# Tests 100 concurrent clients for 1000 requests
echo "TESTING 100 CONCURRENT USERS"
echo "TESTING 100 CONCURRENT USERS" >> load_test_report.txt
loadtest http://localhost:9001/ -t 20 -c 100 -k -n 1000 >> load_test_report.txt
echo "================================"
echo "================================"

# Tests 200 concurrent clients for 1000 requests
echo "TESTING 200 CONCURRENT USERS"
echo "TESTING 200 CONCURRENT USERS" >> load_test_report.txt
loadtest http://localhost:9001/ -t 20 -c 200 -k -n 1000 >> load_test_report.txt
echo "================================"
echo "================================"
...
echo "TESTING 1000 REQUESTS" >> load_test_report.txt
loadtest http://localhost:9001/ -t 20 -c 10 -k -n 1000 >> load_test_report.txt
echo "================================"
echo "================================"
...
loadtest http://localhost:9001/ -t 20 -c 10 -k -n 5000 >> load_test_report.txt
echo "================================"
echo "================================"
...
echo "TESTING 100 REQUESTS PER SECOND" >> load_test_report.txt
loadtest http://localhost:9001/ -t 20 -c 10 -k --rps 100 >> load_test_report.txt
echo "================================"
echo "================================"

# Tests 10 concurrent clients for 300 RPS
echo "TESTING 300 REQUESTS PER SECOND"
echo "TESTING 300 REQUESTS PER SECOND" >> load_test_report.txt
loadtest http://localhost:9001/ -t 20 -c 10 -k --rps 300 >> load_test_report.txt
echo "================================"
echo "================================"

# Tests 10 concurrent clients for 500 RPS
echo "TESTING 500 REQUESTS PER SECOND"
echo "TESTING 500 REQUESTS PER SECOND" >> load_test_report.txt
loadtest http://localhost:9001/ -t 20 -c 10 -k --rps 500 >> load_test_report.txt
echo "================================"
echo "================================"

echo "FINISHED STRESS TESTING ETHERPAD"
echo "================================"
echo "REPORT CAN BE FOUND IN CURRENT DIRECTORY IN A FILE CALLED load_test_report.txt"